...
try {
    ...
    $api->respond();
		...
		$logger->log('ERROR', 'Download hanlder threw a fatal JHM Exception', ['exception' => $e->getMessage()])
    http_response_code('502');    
} catch (Exception $e) {
		$logger->log('ERROR', 'Download hanlder threw a fatal Generic Exception', ['exception' => $e->getMessage()])
